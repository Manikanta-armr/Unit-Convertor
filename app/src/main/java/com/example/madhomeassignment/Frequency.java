    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    Toast.makeText( Frequency.this,"Please Enter the values",Toast.LENGTH_LONG).show();
                }
                else if(textfrom.getText().equals("---") || textto.getText().equals("---"))
                {
                    Toast.makeText(Frequency.this,"Please Select the Units",Toast.LENGTH_LONG).show();
                }
                else {
        ...
        fform.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(Frequency.this);
